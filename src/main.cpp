...
vex::motor left_motor_1_top(vex::PORT1, vex::gearSetting::ratio6_1, true);
vex::motor left_motor_1_bottom(vex::PORT2, vex::gearSetting::ratio6_1, false);
vex::motor left_motor_2(vex::PORT3, vex::gearSetting::ratio6_1, false);
vex::motor right_motor_1_top(vex::PORT4, vex::gearSetting::ratio6_1, false);
vex::motor right_motor_1_bottom(vex::PORT5, vex::gearSetting::ratio6_1, true);
vex::motor right_motor_2(vex::PORT6, vex::gearSetting::ratio6_1, true);
vex::motor_group left(left_motor_1_top, left_motor_1_bottom, left_motor_2);
vex::motor_group right(right_motor_1_top, right_motor_1_bottom, right_motor_2);
vex::brain brain;
vex::controller controller;

#define BASE_WIDTH 27.0 // ensure consistent units
#define WHEEL_DIAMETER 3.0 // ensure consistent units
...
void track(void) {
    ...
    auto get_left = [] () -> double { return (left_motor_1_bottom.position(vex::deg) + left_motor_2.position(vex::deg)) * 0.5 * degree_radian * wheel_diameter; };
    auto get_right = [] () -> double { return (right_motor_1_bottom.position(vex::deg) + right_motor_2.position(vex::deg)) * 0.5 * degree_radian * wheel_diameter; };
    x_position = 0.0;
    y_position = 0.0;
    rotation_value = 0.0;
